    ...
    public ResponseEntity<byte[]> createPptxFromYoutubeUrl(
        ...
        try {
            ...
            String geminiPrompt = String.format(
                    "Transforma el siguiente texto en un resumen ideal para una presentación de PowerPoint. Enfócate en la claridad y la concisión, usando títulos de sección y puntos clave en formato de viñetas. El objetivo es que cada viñeta sea fácil de entender de un vistazo. Responde solo con el resumen: '%s'",
                    transcript
            );
